...
2. **Local Environment:** It is assumed the user running the `setup.sh` script is running a standard Linux/macOS environment with Python virtual environments available.
